...
import com.google.mobile.trippy.web.server.service.PlacesDbCacheManager;
...
/**
 */
public class PlacesDbCacheManagerServlet extends HttpServlet {
  /**
   * 
   */
  ...
  @Inject
  public PlacesDbCacheManagerServlet(PlacesDbCacheManager placesDbCacheManager){
  ...
  throws IOException {
    final Logger logger = Logger.getLogger(
        PlacesDbCacheManagerServlet.class.getName());

...
import com.google.mobile.trippy.web.client.view.SearchBarView;

/**
 * Provider for search panel
 * 
 * 
 */
public class SearchBarProvider implements Provider<SearchBarPresenter> {

  private final SingletonComponents singletonComponents;
  private SearchBarPresenter.Display display;

  public SearchBarProvider(final SingletonComponents singletonComponents) {
    this(null, singletonComponents);
  }

  public SearchBarProvider(final SearchBarPresenter.Display display,
  ...
  public SearchBarPresenter get() {
    if (display == null) {
      return new SearchBarPresenter(new SearchBarView(), singletonComponents);
    } else {
      return new SearchBarPresenter(display, singletonComponents);
    }
  }
}

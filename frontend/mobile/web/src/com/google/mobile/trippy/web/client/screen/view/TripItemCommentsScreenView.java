...
/**
 * view for {@link TripItemCommentsScreenPresenter}.
 * 
 * 
 */
public class TripItemCommentsScreenView extends Composite implements 
    TripItemCommentsScreenPresenter.Display {

  /** UI Binder. */
  @UiTemplate("ScreenView.ui.xml")
  interface Binder extends UiBinder<Widget, TripItemCommentsScreenView> {
  }

  private static Binder uiBinder = GWT.create(Binder.class);

  public TripItemCommentsScreenView() {
  ...
  @Override
  public void setBody(final CommentAddPresenter.Display addDisplay, 
      final CommentsPresenter.Display commentList) {
    body.clear();
    body.add(addDisplay.asWidget());
    body.add(commentList.asWidget());
  }
}

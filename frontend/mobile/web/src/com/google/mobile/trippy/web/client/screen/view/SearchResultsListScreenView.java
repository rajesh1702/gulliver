...
/**
 * This class is responsible to show the view for search results.
 * 
 * 
 */
public class SearchResultsListScreenView extends Composite implements
    SearchResultsListScreenPresenter.Display {

  /** UI Binder. */
  @UiTemplate("ScreenView.ui.xml")
  interface Binder extends UiBinder<Widget, SearchResultsListScreenView> {
  }

  /** UIBinder instance. */
  private static Binder uiBinder = GWT.create(Binder.class);

  public SearchResultsListScreenView() {
  ...
  @Override
  public void setBody(final SearchResultsListPresenter.Display display) {
    body.clear();

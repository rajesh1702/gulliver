...
/**
 * view for {@link TripListScreenPresenter}.
 * 
 *
 */
public class TripListScreenView extends Composite implements TripListScreenPresenter.Display {
  
  /** UI Binder. */
  @UiTemplate("ScreenView.ui.xml")
  interface Binder extends UiBinder<Widget, TripListScreenView> {
  }
  ...
  @Override
  public void setBody(final TripListPresenter.Display display) {
    body.clear();

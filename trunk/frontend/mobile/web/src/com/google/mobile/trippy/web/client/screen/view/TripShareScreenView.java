...
import com.google.mobile.trippy.web.client.screen.presenter.TripShareScreenPresenter.Display;
 ...
 *
 */
public class TripShareScreenView extends Composite implements Display {
  
  /** UI Binder. */
  @UiTemplate("ScreenView.ui.xml")
  interface Binder extends UiBinder<Widget, TripShareScreenView> {
  }

  private static Binder uiBinder = GWT.create(Binder.class);

  public TripShareScreenView() {
  ...
  @Override
  public void setBody(final TripSharePresenter.Display display) {

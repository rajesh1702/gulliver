...
import com.google.mobile.trippy.web.client.screen.view.FooterView;

/**
 */
public class FooterPresenterProvider implements Provider<FooterPresenter> {
  private final SingletonComponents singletonComponents;

  public FooterPresenterProvider(final SingletonComponents singletonComponents) {
    this.singletonComponents = singletonComponents;
  }
  
  @Override
  public FooterPresenter get() {
    return new FooterPresenter(new FooterView(), singletonComponents);
  }
